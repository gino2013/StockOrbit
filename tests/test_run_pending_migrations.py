...
with engine.begin() as conn:
    # position_note_history/fire_settings are introduced together with
    # migrations 0005/0006, so no real pre-Alembic deploy could ever have
    # created them - drop the copies create_all() just made so this
    # simulated legacy DB accurately reflects pre-0005 structure, and
    # each migration's own CREATE TABLE runs for real below instead of
